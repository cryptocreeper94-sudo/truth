...
- [DVE video ingestion](dve-video-ingestion.md) — YouTube/Rumble/Vimeo block server-side yt-dlp from this workspace (bot checks); archive.org works; use it for pipeline tests.
