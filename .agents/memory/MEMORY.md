...
- [DVE pipeline quirks](dve-pipeline.md) — yt-dlp/faster-whisper need plain pip (managed installer hits Nix store); labels are separate from Physical Evidence statuses.
